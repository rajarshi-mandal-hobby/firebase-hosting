...
export const ConfigFormCards: React.FC<ConfigFormCardsProps> = ({
  ...
  const handleRoomAutoFill = (floor: string) => {
    ...
    if (bedValue && bedValue !== '') {
      const numValue = typeof bedValue === 'number' ? bedValue : parseFloat(bedValue.toString());
          ...
          <SimpleGrid cols={{ base: 1, md: 2 }} spacing='sm'>
            ...
            <ConfigNumberInput
              ...
              onChange={(value: string | number) => {
                configForm.setFieldValue(`bedTypes.2nd.Room`, handleNumericValue(value));
            ...
            <ConfigNumberInput
              ...
              onChange={(value: string | number) => {
                configForm.setFieldValue(`bedTypes.2nd.Special Room`, handleNumericValue(value));
      ...
      <Card withBorder p='md'>
        ...
        <SimpleGrid cols={{ base: 1, md: 2 }} spacing='sm'>
          ...
          <ConfigNumberInput
            ...
            onChange={(value: string | number) => {
              configForm.setFieldValue(`bedTypes.3rd.Room`, handleNumericValue(value));
      ...
      <Card withBorder p='md'>
        ...
        <SimpleGrid cols={{ base: 1, md: 2 }} spacing='sm'>
          <ConfigNumberInput
            ...
            onChange={(value: string | number) => {
              configForm.setFieldValue('defaultSecurityDeposit', handleNumericValue(value));
          ...
          <ConfigNumberInput
            ...
            onChange={(value: string | number) => {
              configForm.setFieldValue('wifiMonthlyCharge', handleNumericValue(value));
