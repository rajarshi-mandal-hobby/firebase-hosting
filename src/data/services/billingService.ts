...
// import type { ElectricBill, RentHistory } from '../types';
...
// export async function saveBill(bills: ElectricBill[]): Promise<SaveResult> {
//   await simulateNetworkDelay(1000);

//   const fn = httpsCallable(functions, 'saveBill');
