import { Accordion, Button, Group, List, Modal, Stack, Title, Text, SimpleGrid } from "@mantine/core";
import { useBillsConfirmModal } from "./hooks/useBillsConfirmModal";
				...
				<Stack gap='xl'>
					...
					<Accordion variant='separated'>
						...
						{wifiChargesPerHead > 0 && (
							<AccordionItem
								title={`WiFi Charges: ${wifiChargesPerHead.toIndianLocale()}/Head`}
						...
						{additionalExpensesPerHead > 0 && (
							<AccordionItem
								title={`Expenses: ${additionalExpensesPerHead.toIndianLocale()}/Head`}
