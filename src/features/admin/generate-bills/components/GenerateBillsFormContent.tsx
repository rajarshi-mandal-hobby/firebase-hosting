...
import { MyLoadingOverlay, GroupIcon, NumberInputWithCurrency, FormClearButton } from "../../../../shared/components";
...
export function GenerateBillsFormContent({ billingData }: { billingData: GenerateBillsData }) {
	const {
		form,
