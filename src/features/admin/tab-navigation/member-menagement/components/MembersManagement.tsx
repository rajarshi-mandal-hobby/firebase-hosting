...
import { useMembersManagement } from "../../../../members/hooks/useMembersManagement";
		...
		<>
			...
			{getFilteredData.filteredMembers.length > 0 ?
				<Suspense fallback={<LoadingBox />}>
					<MembersContent members={getFilteredData.filteredMembers} isActiveMembers={memberFilter.accountStatus === "active"} />
				</Suspense>
