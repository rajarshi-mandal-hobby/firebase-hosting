...
import { MemberDetailsList, RentDetailsList } from '../../../shared/components';
import { getStatusAlertConfig } from '../../../shared/utils';
import type { Member } from '../../../data/types';
import { IconQrCode, IconUpi } from '../../../shared/icons';
...
export function MemberProfile({
  ...
  const alertConfig = currentMonthRent.status ? getStatusAlertConfig(currentMonthRent.status) : null;
  ...
  return (
      <>
          ...
          <Stack gap='md'>
              <Title order={4}>Rent for {currentMonthRent.id ? currentMonthRent.id : 'Current Month'}</Title>

              {currentMonthRent && <RentDetailsList rentHistory={currentMonthRent} />}
                  ...
                  <>
                      <Group justify='flex-end' align='center' gap='lg'>
                          <HoverCard width={280} shadow='md' withArrow>
                              ...
                              <HoverCard.Dropdown>
                                  <Text size='sm'>
                                      The &apos;Pay&apos; button simply opens your UPI app—just like scanning a QR code. It
                                      does not track payment status. After completing the payment, please send a
                                      screenshot to admin for verification.
                                  </Text>
                              </HoverCard.Dropdown>
                          </HoverCard>
                          {/* <Button
                              ...
                              component='a'
                              href={
                                  isPaymentDisabled || !currentMonthHistory ? undefined : (
                                      generateUPIUri(
                                          currentMonthHistory.currentOutstanding,
                                          member.name,
                                          currentMonthHistory.id
                                      )
                                  )
                              }
                          >
          ...
          {/* <Group justify='center'>
              <Button
                  ...
                  disabled={historyButtonConfig.disabled}
              >
