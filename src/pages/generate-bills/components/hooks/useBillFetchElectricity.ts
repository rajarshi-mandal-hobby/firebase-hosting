...
import { DB, ERROR_CAUSE, type Bill, type Floor } from '../../../../data/types';
...
export const fetchElectricity = async (
    ...
    // 2. Fetch Data
    const docRef = doc(db, DB.billsCol, monthId);
    ...
    const bill = docSnapshot.data() as Bill;
    const prevMap = bill.idNameMap;
