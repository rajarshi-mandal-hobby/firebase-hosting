...
import { computePerHeadBill } from '../components/utils/utils';
import type { BillFormData } from '../components/hooks/useBillsForm';
...
export const useBillsConfirmModal = (formData: BillsConfirmModalFormData | null, opened: boolean) => {
    ...
    const wifiChargesPerHead = computePerHeadBill(formData.wifiMonthlyCharge, formData.wifiMemberIds.length);
