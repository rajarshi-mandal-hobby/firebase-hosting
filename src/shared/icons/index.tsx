...
import { type ReactElement, type SVGProps, Children, cloneElement, isValidElement } from 'react';
...
const createCustomSvg = (svg: React.ReactElement<CustomSvgProps, 'svg'>, displayName: string) => {
